...
util.setCurrentPath = function (vm, name) {
	...
	} else if (name === 'other_index') {
		currentPathArr = [
			{
				title: util.handleTitle(vm, util.getRouterObjByName(vm.$store.state.app.routers, 'other_index')),
				path: '',
				name: 'other_index'
			}
		];
	} else if ((name.indexOf('_index') >= 0 || isOtherRouter) && name !== 'home_index' && name !== 'other_index') {
		currentPathArr = [
			{
				title: util.handleTitle(vm, util.getRouterObjByName(vm.$store.state.app.routers, 'home_index')),
				path: Cookies.get('access') == 0 ? '/home' : '/other-index',
